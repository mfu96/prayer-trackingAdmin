...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        {
        path: 'employee',
        loadComponent: () => import('./components/employee-component/employee-component').then((c) => c.EmployeeComponent)
      },    {
        path: 'employeeG',
        loadComponent: () => import('./components/employee-gcomponent/employee-gcomponent').then((c) => c.EmployeeGComponent)
      },
      {
        path: 'apexchart',
